...
def acertijo_uno():
    try: 
        respuesta_uno = input('USTED HA RECIVIDO UN ARCHIVO, DESEA ABRIRLO? PRESIONE CUALQUIER NUMERO O LETRA     ')
        arch = open("unoacertijo.txt", "r")
        linea = arch.readline( )
        while linea:
            print(linea)
            linea = arch.readline( )
...
def acertijo_tres():
    try: 
        respuesta_uno = int(input('USTED HA RECIVIDO UN ARCHIVO, DESEA ABRIRLO? PRESIONE CUALQUIER NUMERO O LETRA   '))
        arch = open("tresacertijo.txt", "r")
        linea = arch.readline( )
        while linea:
            print(linea)
            linea = arch.readline( )
        arch1 = open("password.txt", "w")
